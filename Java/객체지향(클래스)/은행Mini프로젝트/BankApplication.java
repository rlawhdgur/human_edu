		...
		private static void creatAccount () {
			...
			Account ac = new Account (ano, owner, balance);
				...
				for (i=0; i<accountArray.length; i++) {
					...
					// accountArray 변수에 앞에서 탐색하면서 비어있는 곳에 Account 클래스의 객체를 대입함.
			...
			private static void accountList () {
				...
				// 반복문을 통해서 계좌목록을 가져옴.
				// accountArray 변수는 Account객체들을 담아 놓은 배열변수이므로,
			...
			private static void deposit () {
				...
				System.out.printf("예금에 성공하였으며 현재잔고는 %d 입니다. \n", nextBalance);
			}
			...
			private static void withdraw () {
				...
				ac.setBalance(nextBalance);
				System.out.printf("출금이 성공하였으며 현재잔고는 %d 입니다. \n", nextBalance);
			}
