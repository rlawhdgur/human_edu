window.addEventListener("load", function () {
    ...
    let templeteButton = document.querySelector("#templete-button");
    ...
    cloneButton.onclick = function () {
        ...
        // false : 해당하는 node만 복제. (위의 경우는 tr태그만 복제.)
        console.log(trNode);
    ...
    inputButton.onclick = function () {
        ...
        // tdsNode[0].textContent = notices[1].id;
        // tdsNode[1].textContent = notices[1].title;
        // tdsNode[2].textContent = notices[1].contents;
        // tdsNode[3].textContent = notices[1].writer;
